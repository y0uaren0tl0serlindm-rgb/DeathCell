extends SceneTree
## One-shot import preparation for the generated v7 passing poses. The other
## four frames are exact copies of already normalized v6 art.

const GENERATED_PATHS := [
	"res://assets/characters/player/animations/deathcell_hero_run_v7_02_passing_a.png",
	"res://assets/characters/player/animations/deathcell_hero_run_v7_05_passing_b.png",
]
